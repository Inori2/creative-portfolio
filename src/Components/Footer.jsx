...
export default function Footer() {
  ...
  return (
    <section className="bg-neutral-950 w-screen min-h-screen flex flex-col justify-between px-5 pb-5 pt-20 lg:pt-40">
      {/* Headline */}
      ...
      <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-5 mt-20">
        ...
        <div className="lg:col-start-5 lg:col-span-2 flex flex-col gap-4">
          <h4 className="font-primary text-neutral-50 font-semibold mb-2">
            Social
          </h4>
      ...
      <div className="w-full flex justify-between items-end mt-20 pt-5 border-t border-neutral-900">
        ...
        <span className="font-primary text-neutral-600 text-sm uppercase tracking-wide w-1/3">
